...
def edl_loss(func, y, alpha, epoch_num, num_classes, annealing_step, device=None):
    ...
    alpha = alpha.to(device)
    S = torch.sum(alpha, dim=1, keepdim=True)
    # print("Shapes: ", S.shape, alpha.shape, y.shape)
    ...
    # print("A: ", torch.mean(A), A.shape)
    # print("KL : ", torch.mean(kl_div), kl_div.shape)
...
#(evidence, y, epoch=1,evid_reg_way = 'kl', ev_reg_strength = 1):
